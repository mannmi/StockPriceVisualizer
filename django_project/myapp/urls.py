...
from .views import GetTickers, GetWatchedListAll, UpdateWatchList, AddToWatchList, RemoveFromWatchList, \
    UpdateTickerList, StoreTickerList, GetAllTickersFile, LoadData, PlotGraphData, GetTickersFromVariable, GetTickersFromDB, \
    GetLoger
...
urlpatterns = [
    ...
    path('plot_graph/', PlotGraphData.as_view(), name='plot_graph'),
